...
export default function MisCitasContent() {
  ...
  if (status === "loading" || loading) return <div className="text-center py-12 text-fg-muted">Cargando...</div>;
    ...
    <div>
      ...
      {appointments.length === 0 ? (
        <div className="text-center py-16">
          <div className="w-16 h-16 rounded-full bg-card-border flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-fg-secondary font-medium">No tienes citas agendadas.</p>
          <Link href="/agendar" className="inline-flex items-center gap-2 mt-4 text-sm font-semibold text-primary hover:underline min-h-[44px]">
            Agendar una hora &rarr;
          </Link>
        </div>
      ) : (
